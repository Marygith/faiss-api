...
output_csv_path = 'D:\\diplom\\data\\passage_data.csv'
with open(output_csv_path, 'w') as csv_file:
    csv_file.write("id," + ",".join([f"dim{i}" for i in range(768)]) + "\n")  # Header
...
output_embeddings_path = 'D:\\diplom\\data\\new_passage_embeddings.npy'
...
faiss_index_path = 'D:\\diplom\\data\\faiss_index_with_ids'
